...
{
    public class FormKhachHangEditInput
    {
        ...
        private int oldidkhachhang;
        public int OldIdKhachHang { get { return this.oldidkhachhang; } set { this.oldidkhachhang = value; } }
        ...
        public List<String> GetValidate()
        {
            ...
            if (!(OldIdKhachHang >= 0))
            {
                errors.Add("Id khách hàng cũ không thể để trống");
            }
